import {
  ...
  import {
    ...
    getAllItem,
    deleteCheckItem,
  } from "./InsurranceService";
  
  
  import AgencyDialog from "./InsurranceDialog";
  ...
  class Insurrance extends React.Component {
    state = {
      rowsPerPage: 10,
      page: 0,
      data: [],
    ...
    render() {
      ...
      let columns = [
        ...
        { title: t("general.level"), field: "muc", width: "150" },
