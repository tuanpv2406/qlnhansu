...
import AgencyDialog from "./DepartmentDialog";
...
class Department extends React.Component {
  ...
  search() {
    this.setState({ page: 0 }, function () {
      ...
      getAllPhongBan(searchObject).then(res => {
  ...
  updatePageData = () => {
    ...
    searchObject.pageIndex = this.state.page + 1;
    searchObject.pageSize = this.state.rowsPerPage;
    getAllPhongBan(searchObject).then(({ data }) => {
  ...
  render() {
    ...
    let columns = [
      ...
      { title: t("general.quantity"), field: "soLuongNV", align: "left", width: "150" },     
